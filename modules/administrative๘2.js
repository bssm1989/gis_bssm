(function(){
	LoadMap(function(map){
		var provinces_list = [18,32,33,35,37,46,47,49,58,94];
		...
		var admin_server = 'https://gistdaportal.gistda.or.th/arcgis/rest/services/app/admin_poly/MapServer/0/query';
		var administratives = [
			{
				name:'Provinces',
