...
<script src="https://cesiumjs.org/releases/1.70/Build/Cesium/Cesium.js" crossorigin="anonymous"></script>
...
function LoadMap(c){
	...
	},icon:'https://cesiumjs.org/releases/1.67/Build/Cesium/Widgets/Images/TerrainProviders/CesiumWorldTerrain.png'});
	$.each(Modules,function(){
