...
<link href="../Cesium-1.81/Build/Cesium/Widgets/widgets.css" rel="stylesheet">
...
<body>
<script>
/* alert('ประกาศ...ย้ายเซิร์ฟเวอร์ 24 ชั่วโมง วันที่ 18 ม.ค. 2564 เวลา 0.00-24.00 น.'); */
</script>
<div id="menu_bar" style="user-select: none;height:42px;background-color: #042f52;z-index:99;position: fixed;top:0;width:100%;"></div>
<script type="text/javascript" src="../Cesium-1.75/Apps/Sandcastle/Sandcastle-header.js"></script>
<script src="../Cesium-1.81/Build/Cesium/Cesium.js" crossorigin="anonymous"></script>
...
<script id="cesium_sandcastle_script"></script>
...
//$('#menu_bar').append('<div id="toolbar" style="margin-top: 42px;"></div>');
...
function LoadMap(c){
	...
	},icon:'../Cesium-1.81/Build/Cesium/Widgets/Images/TerrainProviders/CesiumWorldTerrain.png'});
	$.each(Modules,function(){
